...
class Customer:
    def __init__(self, name, age, address, account_number, balance, account_type):
        print("WElcome to The Bank Customer Service... ")
        self.name = name
        self.age = age
        self.address = address

        # Creating BankAccount Object For the Customer
        self.account = BankAccount(account_number, balance, account_type)

    def __del__(self):
        print(f"Customer {self.name}'s record is deleted.. ")


customer1 = Customer("Sanjeev",18,"Kathmandu",123456,15000000000000000,"saving")